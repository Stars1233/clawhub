...
- Repo-local developer skills under `.agents/skills/` are allowed when they support working on this codebase; keep top-level `skills/` reserved for installed/published skill content and ignored by git.
